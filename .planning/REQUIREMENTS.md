...
- [ ] **EXP-01**: User sees an experience timeline with a vertical line, 4 entries, and visual distinction between the current role and past roles (orange pulse glow for current)
- [ ] **EXP-02**: User sees an education list with degree title, institution, years, and detail line for each entry
...
- [ ] **FOOTER-01**: User sees a giant wordmark ("MONKEY / solutions.") with Fraunces italic accent on "solutions."
- [ ] **FOOTER-02**: Footer contains a 4-column meta grid: studio address, navigation links, social links, and availability status
- [ ] **FOOTER-03**: Footer has a bottom strip with copyright text and version info
