...
Plans:
**Wave 1**
- [ ] 06-01-PLAN.md — CSS foundation: custom @theme breakpoints (ms: 760px, compact: 480px), .focus-ring utility, .sr-only utility, extended prefers-reduced-motion rule

**Wave 2** *(blocked on Wave 1 completion)*
- [ ] 06-02-PLAN.md — Hero, About, Experience responsive (md:→ms: prefix) + SiteHeader nav overflow fix (RESP-01, RESP-03, A11Y-04 partial)

**Wave 3** *(blocked on Wave 2 completion)*
- [ ] 06-03-PLAN.md — Services, Contact, Footer, Work, StatusDot, TerminalCard (RESP-01, RESP-02, A11Y-01, A11Y-02, A11Y-03, A11Y-04)
**UI hint**: yes
...
| 6. Responsive + Accessibility | 0/3 | Not started | - |
